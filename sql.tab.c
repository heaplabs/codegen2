...
{
  "$end", "error", "$undefined", "CREATE", "TABLE", "'('", "')'", "';'",
  "table_name", "identifier", "','", "$accept", "stmt", "create_stmt",
...
{
       0,   256,   257,   258,   259,    40,    41,    59,   260,   261,
      44
};
# endif
...
{
      12,     1,     5,     4,    13,     1,     7,     0,     8,     9,
      11,    14,     6,     0,    15,    16
};

static const yytype_int8 yycheck[] =
{
       6,     3,     0,     4,    10,     3,     9,    -1,     5,     9,
       9,     7,     2,    -1,     9,     9
};
